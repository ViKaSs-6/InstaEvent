...
* **Alibaba-Style Direct Chat Hub:** A built-in messaging interface that allows customers to communicate directly with vendors for custom quotes and negotiations.
* **Role-Based Portals:** 
  * **Customers:** Manage bookings, user settings, privacy preferences, and direct messages.
  * **Vendors:** Register, list their services, track bookings, and reply to client inquiries.
  * **Admins:** Oversee and moderate platform listings.
* **Persistent Data & Auth:** Integrated authentication and database storage supporting multi-role accounts.
...
1. Clone the repository:
   ```bash
   git clone [https://github.com/your-username/insta-events.git](https://github.com/your-username/insta-events.git)
